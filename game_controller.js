...
export default class GameController {
    constructor() {
            ...
            this._CanvasDrawEngine.CANVAS.addEventListener("touchstart", this._PickPiece);
            this._CanvasDrawEngine.CANVAS.addEventListener("mouseup", this._dropPiece);
            this._CanvasDrawEngine.CANVAS.addEventListener("touchend", this._dropPiece);
